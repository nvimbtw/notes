...
== Podatek
- Je predstavitev dejstva ali koncepta na formalen način,
- Je poljubna predstavitev s pomočjo simbolov ali analognih veličin,
- Pravzaprav le števila ali znaki,
- *Ko podatku dodamo pomen, dobimo informacijo.*

== Informacija
- Je pomen, ki ga človek pripiše podatkom,
- Lahko so ovrednoteni podatki v specifični situaciji,
- Lahko pa je tudi novo spoznanje, ki ga človek doda svojemu poznavanju sveta.

== Dimenzije informacije
=== Vrednost
- Informacijsko vrednost lahko določimo kot vrednost spremembe v obnašanju prejemnika, zmanjšano za stroške pridobitve informacije.
- Vrednost informacije se s časom manjša
- Pravočasnost da se na njeni osnovi dobro odločimo $arrow.r$ visoka vrednost
- Prepozna $arrow.r$ zelo nizka ali nič.
- Odvisna je tudi od kakovosti.

=== Količina
Informacije je merljiva količina - osnovna enota: bit
Informacija odstrani določeno stopnjo neznanja
...
+ Dostopnosti - Informacija je dostopna, kadar je enostavno dosegljiva in na voljo uporabnikom takrat, ko jo potrebujejo, brez nepotrebnih ovir ali omejitev.
